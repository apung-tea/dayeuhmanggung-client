...
const BestOf = ({ 
  ...
  const pageSize = 10;
  const totalPages = Math.ceil(bestOfData.length / pageSize);
  const pagedData = bestOfData.slice((page - 1) * pageSize, page * pageSize);
  React.useEffect(() => { setPage(1); }, [bestOfData]);
  return (
            ...
            <table className="min-w-full bg-white text-xs">
              <thead>
                <tr className="bg-gradient-to-r from-gray-50 to-gray-100 border-b-2 border-gray-300">
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider border-r border-gray-200">ID</th>
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider border-r border-gray-200">Judul</th>
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider border-r border-gray-200">Lokasi</th>
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider border-r border-gray-200 hidden md:table-cell">Deskripsi</th>
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider border-r border-gray-200">Durasi</th>
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider border-r border-gray-200">Jam Buka</th>
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider border-r border-gray-200">Harga Tiket</th>
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider border-r border-gray-200">Gambar</th>
                  <th className="px-2 py-2 text-left font-semibold text-gray-700 uppercase tracking-wider">Aksi</th>
                </tr>
              </thead>
                ...
                {pagedData.length > 0 ? (
                  pagedData.map((item, index) => (
                    <tr key={item.id} className={`hover:bg-gray-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                      <td className="px-2 py-2 whitespace-nowrap border-r border-gray-200 border-b border-gray-200">{item.id}</td>
                      <td className="px-2 py-2 whitespace-nowrap font-medium border-r border-gray-200 border-b border-gray-200">{item.judul}</td>
                      <td className="px-2 py-2 whitespace-nowrap border-r border-gray-200 border-b border-gray-200">{item.lokasi}</td>
                      <td className="px-2 py-2 text-gray-500 max-w-xs truncate border-r border-gray-200 border-b border-gray-200 hidden md:table-cell">{item.deskripsi}</td>
                      <td className="px-2 py-2 whitespace-nowrap border-r border-gray-200 border-b border-gray-200">{item.durasi}</td>
                      <td className="px-2 py-2 whitespace-nowrap border-r border-gray-200 border-b border-gray-200">{item.jam_buka}</td>
                      <td className="px-2 py-2 whitespace-nowrap border-r border-gray-200 border-b border-gray-200">{Number(item.harga_tiket).toLocaleString('id-ID')}</td>
                      <td className="px-2 py-2 whitespace-nowrap border-r border-gray-200 border-b border-gray-200">
                        {item.gambar ? (
                          <img 
                      ...
                      <td className="px-2 py-2 whitespace-nowrap font-medium border-b border-gray-200">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block mb-2 text-sm font-medium text-green-700">Durasi</label>
                        <input
                          className="w-full border border-green-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-300 bg-green-50"
                      ...
                      <div>
                        <label className="block mb-2 text-sm font-medium text-green-700">Jam Buka</label>
                        <input
                          className="w-full border border-green-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-300 bg-green-50"
                    ...
                    <div>
                      <label className="block mb-2 text-sm font-medium text-green-700">Harga Tiket</label>
                      <input
                        className="w-full border border-green-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-300 bg-green-50"
