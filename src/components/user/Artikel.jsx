            ...
            {articles.map((article) => (
              ...
              >
                <div className="relative h-48 md:h-72">
                  ...
                  {/* Label kategori */}
                  {article.kategori && (
                    <span className="absolute top-4 left-4 bg-emerald-500 text-white text-base md:text-lg font-bold px-4 md:px-5 py-2 rounded-md shadow font-raleway z-20">
                      {article.kategori}
                    </span>
                  )}
                  {/* Icon gambar */}
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-5 text-white z-10">
                    <h3 className="text-2xl font-raleway font-semibold mb-2 leading-snug line-clamp-2">
                      {article.judul}
                    </h3>
                    {/* Tanggal event */}
