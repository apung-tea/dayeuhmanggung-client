          ...
          <div className={`grid ${gridClass} gap-2`}>
            {visibleData.map((item) => (
              ...
              >
                ...
                />
                <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/60 to-transparent p-4 flex items-end min-h-[40px] sm:min-h-[60px]">
                  <span className="text-base sm:text-lg font-semibold text-white drop-shadow-md">
                    {item.kategori || item.file_foto.split('.')[0]}
                  </span>
                </div>
              </div>
            ))}
